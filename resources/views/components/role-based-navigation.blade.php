...
<x-sidebar-section title="Radicación" :collapsible="true" :defaultOpen="true" storageKey="sidebar_radicacion" :collapsedLink="route('radicacion.entrada.index')">
    <x-slot name="icon">
...
<x-sidebar-section title="Gestión" :collapsible="true" :defaultOpen="true" storageKey="sidebar_gestion" :collapsedLink="route('admin.index')">
    <x-slot name="icon">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="w-4 h-4">
    ...
    <!-- Departamentos -->
    <x-sidebar-link :href="route('admin.departamentos.index')" :active="request()->routeIs('admin.departamentos.*')">
        <x-slot name="icon">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="w-6 h-6">
    ...
    <!-- Ciudades -->
    <x-sidebar-link :href="route('admin.ciudades.index')" :active="request()->routeIs('admin.ciudades.*')">
        <x-slot name="icon">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="w-6 h-6">
...
<!-- Sección Sistema -->
<x-sidebar-section title="Sistema" :collapsible="true" :defaultOpen="true" storageKey="sidebar_sistema">
    <x-slot name="icon">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="w-4 h-4">
    ...
    <form method="POST" action="{{ route('logout') }}">
        @csrf
        <button type="submit" class="sidebar-link w-full text-left" title="Cerrar Sesión">
