                ...
                <div class="p-8 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="card-minimal p-6 border-l-4 border-uniradical-blue">
                            ...
                            <button class="w-full btn-institutional" disabled>
                                Próximamente
                            </button>
                        </div>
                        ...
                        <div class="card-minimal p-6 border-l-4 border-gray-300">
                            <h4 class="text-lg font-medium text-gray-800 mb-2">Administración</h4>
                            <p class="text-sm text-gray-600 mb-4 font-light">Gestión de usuarios y configuración</p>
                            <button class="w-full btn-secondary" disabled>
                                Próximamente
                            </button>
                        </div>
                    ...
                    <div class="mt-12 p-6 bg-gray-50 border-l-4 border-gray-300">
                        <h4 class="text-md font-medium text-gray-800 mb-4">Estado del Sistema</h4>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                            ...
                            <div>
                                <span class="text-gray-600 font-light">Versión:</span>
