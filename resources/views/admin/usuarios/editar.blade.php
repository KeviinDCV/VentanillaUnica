        ...
        <div class="container-minimal">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Modifique los campos que desee actualizar.</p>
                </div>

                <form action="{{ route('admin.usuarios.actualizar', $usuario->id) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="role" 
                                ...
                                <option value="ventanilla" {{ old('role', $usuario->role) === 'ventanilla' ? 'selected' : '' }}>
                                    Ventanilla
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                        <h4 class="text-sm font-medium text-gray-800 mb-2">Información del Usuario</h4>
