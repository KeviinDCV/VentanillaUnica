        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <select name="tipo_comunicacion" id="tipo_comunicacion" required
                    ...
                    <option value="memorando" <?php echo e(old('tipo_comunicacion') == 'memorando' ? 'selected' : ''); ?>>Memorando</option>
                    <option value="circular" <?php echo e(old('tipo_comunicacion') == 'circular' ? 'selected' : ''); ?>>Circular</option>
                    <option value="informe" <?php echo e(old('tipo_comunicacion') == 'informe' ? 'selected' : ''); ?>>Informe</option>
                    <option value="acta" <?php echo e(old('tipo_comunicacion') == 'acta' ? 'selected' : ''); ?>>Acta</option>
                    <option value="resolucion" <?php echo e(old('tipo_comunicacion') == 'resolucion' ? 'selected' : ''); ?>>Resolución</option>
                    <option value="oficio" <?php echo e(old('tipo_comunicacion') == 'oficio' ? 'selected' : ''); ?>>Oficio</option>
                    <option value="otro" <?php echo e(old('tipo_comunicacion') == 'otro' ? 'selected' : ''); ?>>Otro</option>
                </select>
            </div>
