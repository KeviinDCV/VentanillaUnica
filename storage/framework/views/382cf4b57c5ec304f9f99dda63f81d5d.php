            ...
            <div class="card-minimal">
                <div class="p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900">
                                    <?php echo e($radicado->fecha_radicado->format('d/m/Y')); ?> - <?php echo e($radicado->hora_radicado->format('H:i:s')); ?>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900"><?php echo e($radicado->remitente->telefono); ?></p>
                            </div>
                            <?php endif; ?>
                            <?php if($radicado->remitente->email): ?>
                            <div>
                                <label class="block text-sm font-medium text-gray-500 mb-1">Email</label>
                                <p class="text-sm text-gray-900"><?php echo e($radicado->remitente->email); ?></p>
                            </div>
                            <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <?php if($radicado->remitente->ciudad || $radicado->remitente->departamento): ?>
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-500 mb-1">Ubicación</label>
                                <p class="text-sm text-gray-900">
                                    <?php echo e($radicado->remitente->ciudad); ?><?php echo e($radicado->remitente->ciudad && $radicado->remitente->departamento ? ', ' : ''); ?><?php echo e($radicado->remitente->departamento); ?>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="text-sm text-gray-900"><?php echo e($radicado->dependenciaDestino->nombre); ?></p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-500 mb-1">Usuario que Radica</label>
                                <p class="text-sm text-gray-900"><?php echo e($radicado->usuarioRadica->name); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <?php if($radicado->subserie): ?>
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-500 mb-1">TRD (Serie/Subserie)</label>
                                <p class="text-sm text-gray-900">
                                    <?php echo e($radicado->subserie->serie->unidadAdministrativa->codigo); ?>.<?php echo e($radicado->subserie->serie->numero_serie); ?>.<?php echo e($radicado->subserie->numero_subserie); ?> - 
                                    <?php echo e($radicado->subserie->serie->nombre); ?> / <?php echo e($radicado->subserie->nombre); ?>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900"><?php echo e($radicado->tipo_comunicacion); ?></p>
                            </div>
                            <div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <p class="text-sm text-gray-900"><?php echo e($radicado->fecha_limite_respuesta->format('d/m/Y')); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <p class="text-sm text-gray-700 whitespace-pre-line"><?php echo e($radicado->observaciones); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($documento->nombre_archivo); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e(number_format($documento->tamaño_archivo / 1024, 2)); ?> KB</p>
                                    </div>
                                </div>
                                <a href="<?php echo e(Storage::url($documento->ruta_archivo)); ?>" 
                                   target="_blank"
...
<?php endif; ?>
<?php /**PATH E:\Hospital\Ventanilla\UniRadic\resources\views/radicacion/salida/show.blade.php ENDPATH**/ ?>