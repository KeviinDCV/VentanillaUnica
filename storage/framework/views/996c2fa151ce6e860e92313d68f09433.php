                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($estadisticas['unidades_administrativas']); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($estadisticas['series']); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($estadisticas['subseries']); ?></p>
                        </div>
                    </div>
                </div>
            </div>
