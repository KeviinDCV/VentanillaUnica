    ...
    ">
        ...
        <nav class="sidebar-nav">
            <?php if(auth()->guard()->check()): ?>
                <?php if (isset($component)) { $__componentOriginal1d4ead596352daa5fa767fe4cca30077 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1d4ead596352daa5fa767fe4cca30077 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.role-based-navigation','data' => ['user' => Auth::user()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('role-based-navigation'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal1d4ead596352daa5fa767fe4cca30077)): ?>
<?php $attributes = $__attributesOriginal1d4ead596352daa5fa767fe4cca30077; ?>
<?php unset($__attributesOriginal1d4ead596352daa5fa767fe4cca30077); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal1d4ead596352daa5fa767fe4cca30077)): ?>
<?php $component = $__componentOriginal1d4ead596352daa5fa767fe4cca30077; ?>
<?php unset($__componentOriginal1d4ead596352daa5fa767fe4cca30077); ?>
<?php endif; ?>
            <?php endif; ?>
        </nav>
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <div :class="{ 'collapsed': !sidebarOpen && window.innerWidth >= 1024 }" class="sidebar-user">
                    <div class="w-10 h-10 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-full flex items-center justify-center flex-shrink-0 relative overflow-hidden shadow-lg border-2 border-white/20">
                        <span class="text-white text-sm font-bold relative z-10"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                    ...
                    <div class="sidebar-user-info">
                        ...
                        <div class="text-xs opacity-80"><?php echo e(ucfirst(Auth::user()->role)); ?></div>
                    </div>
                </div>
...
<?php /**PATH E:\Hospital\Ventanilla\UniRadic\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>