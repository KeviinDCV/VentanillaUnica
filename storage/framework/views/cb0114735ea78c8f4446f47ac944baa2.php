...
<head>
    ...
    <title>Previsualización - Radicado Interno <?php echo e($datosPreview['numero_radicado']); ?></title>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2 text-sm">
                                        <p><strong>Dependencia:</strong> <?php echo e($datosPreview['dependencia_destino']->nombre_completo); ?></p>
                                        <?php if($datosPreview['dependencia_destino']->responsable): ?>
                                            <p><strong>Responsable:</strong> <?php echo e($datosPreview['dependencia_destino']->responsable); ?></p>
                                        <?php endif; ?>
                                        <?php if($datosPreview['dependencia_destino']->telefono): ?>
                                            <p><strong>Teléfono:</strong> <?php echo e($datosPreview['dependencia_destino']->telefono); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3 text-sm">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <p><strong>Prioridad:</strong> <?php echo e(ucfirst($datosPreview['prioridad'])); ?></p>
                                    </div>
                                    <?php if($datosPreview['tipo_anexo']): ?>
                                        <p><strong>Anexo:</strong> <?php echo e(ucfirst($datosPreview['tipo_anexo'])); ?></p>
                                    <?php endif; ?>
                                    ...
                                    <?php if($datosPreview['requiere_respuesta']): ?>
                                        <p><strong>Requiere Respuesta:</strong> Sí</p>
                                        <?php if($datosPreview['fecha_limite_respuesta']): ?>
                                            <p><strong>Fecha Límite:</strong> <?php echo e(\Carbon\Carbon::parse($datosPreview['fecha_limite_respuesta'])->format('d/m/Y')); ?></p>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="p-3 bg-gray-50 rounded-md border">
                                    <?php echo e($datosPreview['observaciones']); ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (window.previewManager) {
                window.previewManager.radicadoData = {
                    ...
                    tipo: 'interno',
                    redirect_url: '<?php echo e(route('radicacion.interna.index')); ?>'
                };
            }
        });
    </script>
...
<?php /**PATH E:\Hospital\Ventanilla\UniRadic\resources\views/radicacion/interna/preview.blade.php ENDPATH**/ ?>