...
<head>
    ...
    <title>Previsualización - Radicado <?php echo e($datosPreview['numero_radicado']); ?></title>
...
<body class="bg-gray-100">
                    ...
                    <div id="documento-preview" class="relative bg-white border-2 border-gray-300 min-h-[800px] p-8">
                        ...
                        <div id="sello-radicado" draggable="false"
                            ...
                            <div class="text-center">
                                <div class="mb-1" style="font-size: 7px; letter-spacing: 0.5px;">RADICADO ENTRADA</div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="text-center border-b-2 border-gray-300 pb-4">
                                ...
                                <h2 class="text-md font-medium text-gray-600 mt-1">COMUNICACIÓN OFICIAL DE ENTRADA</h2>
                            ...
                            <!-- Información del remitente y destino -->
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    <h4 class="font-semibold text-gray-800 mb-3">INFORMACIÓN DEL REMITENTE:</h4>
                                    <div class="space-y-2 text-sm">
                                        <p><strong>Nombre:</strong> <?php echo e($datosPreview['remitente']['nombre_completo']); ?></p>
                                        <?php if($datosPreview['remitente']['tipo_documento']): ?>
                                            <p><strong>Documento:</strong> <?php echo e($datosPreview['remitente']['tipo_documento']); ?> <?php echo e($datosPreview['remitente']['numero_documento']); ?></p>
                                        <?php endif; ?>
                                        <?php if($datosPreview['remitente']['telefono']): ?>
                                            <p><strong>Teléfono:</strong> <?php echo e($datosPreview['remitente']['telefono']); ?></p>
                                        <?php endif; ?>
                                        <?php if($datosPreview['remitente']['email']): ?>
                                            <p><strong>Email:</strong> <?php echo e($datosPreview['remitente']['email']); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-gray-800 mb-3">INFORMACIÓN DEL DESTINO:</h4>
                                    <div class="space-y-2 text-sm">
                                        <p><strong>Dependencia:</strong> <?php echo e($datosPreview['dependencia_destino']); ?></p>
                                        <p><strong>Medio de Recepción:</strong> <?php echo e(ucfirst($datosPreview['medio_recepcion'])); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3 text-sm">
                                    ...
                                    <p><strong>Asunto TRD:</strong> <?php echo e($datosPreview['trd']['asunto']); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="text-center text-sm text-gray-600 border-t border-gray-300 pt-4 mt-8">
                                <div class="grid grid-cols-2 gap-4 text-xs">
                                    <div class="text-left">
                                        <p><strong>Procesado por:</strong> <?php echo e(auth()->user()->name); ?></p>
    ...
    <script>
        // Configuración específica para radicación de entrada
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (window.previewManager) {
                window.previewManager.radicadoData = {
                    ...
                    tipo: 'entrada',
                    redirect_url: '<?php echo e(route('radicacion.index')); ?>'
                };
            }
        });
    </script>
...
<?php /**PATH E:\Hospital\Ventanilla\UniRadic\resources\views/radicacion/entrada/preview.blade.php ENDPATH**/ ?>